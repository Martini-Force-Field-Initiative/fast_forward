...
project = 'FastForward'
copyright = '2025, Fabian Grunewald'
author = 'F. Grunewald '

# The full version, including alpha/beta/rc tags
#release = get_distribution('fastforward').version
...
# latex_documents = [
#     (master_doc, 'FF.tex', 'FF Documentation',
#      author, 'manual'),
# ]
...
man_pages = [
    (master_doc, 'FF', 'FF Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FF', 'FF Documentation',
     author, 'FF', 'One line description of project.',
     'Miscellaneous'),
]
